...
public class EventSystem implements Disposable{
    public enum EventType {
        ...
        LAYOUT_HIDDEN_CARD,
        LAYOUT_ACTIVE_CARD,
        DEAL_ACTIVE_CARDS, SELECT_END_CARD, STATE_CHANGE, CARD_PLAY_FAILED, CARD_PLAY_SUCCESS, REPARENT_ALL_VIEWS, STATE_LOADED, HIGHLIGHT_DECK, SELECT_MULTIPLE_CARDS, INPLAY_CARDS_CHANGED, UNSELECT_MULTIPLE_CARDS,
    }
