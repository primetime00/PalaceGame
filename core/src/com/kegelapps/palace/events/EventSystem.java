...
public class EventSystem implements Disposable{
    public enum EventType {
        ...
        FAILED_HIDDEN_PLAY,
        SUCCESS_HIDDEN_PLAY,
        SHOW_MESSAGE, CARDS_GONE, GAME_OVER, RESTART_GAME, OPTIONS, RESUME_GAME, MAIN_NEW_GAME, QUIT_GAME, MAIN_OPTIONS, OPTIONS_BACK, SHOW_ACKNOWLEDGEMENTS, DISMISS_ACKNOWLEDGEMENTS,
    }
